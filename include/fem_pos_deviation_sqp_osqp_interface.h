#ifndef DNP_DECISION_REFERENCE_LINE_FEM_POS_DEVIATION_SQP_OSQP_INTERFACE_H_
#define DNP_DECISION_REFERENCE_LINE_FEM_POS_DEVIATION_SQP_OSQP_INTERFACE_H_
...
class FemPosDeviationSqpOsqpInterface {
   public:
    ...
    void set_bounds_around_refs(const std::vector<double> &u_bounds_around_refs,const std::vector<double> &l_bounds_around_refs) {
        upper_bounds_around_refs_ = u_bounds_around_refs;
        lower_bounds_around_refs_ = l_bounds_around_refs;
    }
   ...
   private:
    ...
    std::vector<double> upper_bounds_around_refs_;
    std::vector<double> lower_bounds_around_refs_;
    double curvature_constraint_ = 0.2;

    // Weights in optimization cost function
    double weight_fem_pos_deviation_ = 1.0e5;  // 1.0e5
...
#endif  // DNP_DECISION_REFERENCE_LINE_FEM_POS_DEVIATION_SQP_OSQP_INTERFACE_H_
